...
int main(void)
{
  ...
  //
  // Listen makes the socket active and start listenign for incoming connections
  ...
  while (1) {
    ...
    // accept returns a new descriptor for interacting with the client
    ...
    // read from connection_fd --> reading bytes sent by the client
    // write to connection_fd --> sending bytes to the clent
