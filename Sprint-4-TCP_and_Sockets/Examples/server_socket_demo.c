...
int main(void)
{
  ...
  // Bind the socket
  //connects socket to port you want to listen on 
  //tells os to establush connection
  ...
  //makes socket active and start listening 
  ...
  while (1) {
    ...
    //acxcept BLOCKs and waits until a client connection arrives 
...
//uses connection fd to interact with client side communication
//read from cfd -- reading bytes sent by the client
//write from cfd -- sending bytes to the client
