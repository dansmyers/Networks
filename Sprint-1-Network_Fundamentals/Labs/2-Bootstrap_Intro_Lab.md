...
Here is an example HTML page that shows off the basic elements of Bootstrap. Open up your workspace, and create a new HTML file called `bootstrap_example.html`. Copy the 
