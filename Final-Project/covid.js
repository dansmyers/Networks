...
function getCovidData(state) {
  ...
  .then(data =>{
    ...
    document.querySelector('.total-cases').innerHTML = formatNumber(cases);
    document.querySelector('.new-cases').innerHTML = formatNumber(newCases);
    document.querySelector('.total-deaths').innerHTML = formatNumber(deaths);
  })
